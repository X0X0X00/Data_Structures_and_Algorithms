/******************************************************************************
 *  Compilation:  javac Data_TwoSum.java
 *  Execution:    java Data_TwoSum input.txt
 ...
 *
 *
 *  % java Data_TwoSum 2Kints.txt
 *  2
 *
 *  % java Data_TwoSum 1Kints.txt
 *  1
 *
 *  % java Data_TwoSum 2Kints.txt
 *  2
 *
 *  % java Data_TwoSum 4Kints.txt
 *  3
 *
 *  % java Data_TwoSum 8Kints.txt
 *  19
 *
 *  % java Data_TwoSum 16Kints.txt
 *  66
 *
 *  % java Data_TwoSum 32Kints.txt
 *  273
 *
 ******************************************************************************/
...
public class TwoSum {
 ...
 /**
    ...
    public static void main(String[] args)  { 
        ...
        String netID = "zzh133";
          StdOut.printf("%7d %7.1f   %s  %s  %s\n", count, time, timeStamp, netID, args[0]); // 为了作图改为 %7.6f
    } 
} 
